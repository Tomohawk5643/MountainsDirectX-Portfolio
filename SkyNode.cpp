...
SkyNode::SkyNode(wstring name, wstring skyMapFilename, float radius) : SceneNode(name)
{
	_skyCubeFilename = _skyCubeFilename;
	_skySphereRadius = _skySphereRadius;
}
